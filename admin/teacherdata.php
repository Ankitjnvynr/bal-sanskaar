...
$total_records_sql = "SELECT COUNT(*) AS total FROM teachers WHERE name LIKE ?";
                ...
                while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="deleteTeacher.php" class="btn p-0 m-0 mx-1 fs-5"><i class="fa-regular fa-trash-can text-danger"></i></a>
                        </td>
                    </tr>
                <?php endwhile;
            } else
